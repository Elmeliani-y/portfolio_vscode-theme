    ...
    <div id="Contact" className="pb-72 mt-36">
      ...
      <div className="text-[#a2aabc] text-lg mt-5 mx-12 lg:mx-60 flex flex-col items-center text-justify">
        ...
        Actuellement à la recherche d'une nouvelle opportunité,
         vous pouvez me contacter en cliquant sur le bouton ci-dessous.<br/>
          Que vous ayez une question ou simplement envie de dire bonjour, 
          n'hésitez pas à me contacter et je ferai de mon mieux pour vous répondre !
        </code>
        <button className=" border border-lightblue_vs text-lightblue_vs mt-10 p-3 rounded hover:bg-opacity-10 hover:bg-lightblue_vs w-1/2">
          <a href="mailto:youssefelmeliani55@gmail.com">
            <code>Contact</code>
          </a>
        </button>
      </div>
